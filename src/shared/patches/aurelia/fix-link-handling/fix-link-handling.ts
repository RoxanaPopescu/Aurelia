...
/**
 * HACK:
 * The `DefaultLinkHandler` attaches a click listener to the document element, which
...
/**
 * HACK:
 * The `DefaultLinkHandler` does not consider whether `preventDefault()` has been
