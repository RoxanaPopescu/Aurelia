        ...
        const result = await this.apiClient.post<any[]>("logistics/orders/consignor/DetailOrders",
        {
            body:
            {
                ...
                outfitIds: environment.name === "production"
                    ? ["F1003E94-D520-4D0C-959A-AFB76BDC91F3", "78f39900-008f-49bc-b379-369726564346", "22A30D79-0CC8-4D9F-9530-C15016EA40D9", "bae22aaa-a95f-4f0a-b565-877e1bb7c861", "3bfe4bbb-c27b-45b5-8e42-05a64ff938c1"]
