...
export default
{
    "GET /api/v2/searches/query?text=m": result,
    "GET /api/v2/searches/query?text=mo": result,
    "GET /api/v2/searches/query?text=mov": result,
    "GET /api/v2/searches/query?text=move": result,
    "GET /api/v2/searches/query?text=mover": result,
    "GET /api/v2/searches/query?text=mover ": { body: [] }
}
