...
import { DepartureTimeScenario } from "app/model/_route-planning-settings";
...
export class ConfirmDeleteScenarioDialog
{
    ...
    protected scenario: DepartureTimeScenario;

    /**
     * Called by the framework when the modal is activated.
     * @param model The model to use.
     */
    public activate(model: DepartureTimeScenario): void
    {
        this.scenario = model;
    }
