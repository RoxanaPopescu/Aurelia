...
import { DistributionCenter } from "app/model/distribution-center";

@autoinject
export class ConfirmDeleteDistributionCenterDialog
{
    /**
     ...
     */
    public activate(model: DistributionCenter): void
    {
        this.distributionCenter = model;
    }
