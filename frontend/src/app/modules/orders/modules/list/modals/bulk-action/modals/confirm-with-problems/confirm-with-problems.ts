...
@autoinject
export class ConfimWithProblemsDialog
{
    /**
    ...
    protected model: { totalOrders: number; ordersCanBeChanged: number };

    /**
     * Called by the framework when the modal is activated.
     * @param model The model to use.
     */
    public activate(model: { totalOrders: number; ordersCanBeChanged: number }): void
    {
        this.model = model;
    }
