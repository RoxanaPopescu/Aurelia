...
import { CommunicationTriggerInfo } from "app/model/_communication";

@autoinject
export class ConfirmDeleteTriggerDialog
{
    /**
    ...
    protected trigger: CommunicationTriggerInfo;

    /**
     * Called by the framework when the modal is activated.
     * @param model The model to use.
     */
    public activate(model: CommunicationTriggerInfo): void
    {
        this.trigger = model;
    }
